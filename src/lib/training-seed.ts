...
const SEED_EXERCISES: SeedExercise[] = [
  ...
  { nombre: "Peso muerto rumano con mancuernas", grupo_muscular: "isquiosurales", tipo: "fuerza" },
  ...
  { nombre: "Step-up bajo (rango corto)", grupo_muscular: "cuádriceps", tipo: "fuerza" },
  {
